    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'settings.php') ) {echo 'active';} ?>">
			          <a href="settings.php">
			            <i class="fa fa-sliders"></i> <span>Cài đặt giao diện trang web</span>
			          </a>
			        </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="top-category.php"><i class="fa fa-circle-o"></i> Danh mục phòng</a></li>
                            <li><a href="mid-category.php"><i class="fa fa-circle-o"></i> Danh mục sản phẩm</a></li>
                            <li><a href="end-category.php"><i class="fa fa-circle-o"></i> Danh mục loại sản phẩm</a></li>
                        </ul>
                    </li>


                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') || ($cur_page == 'product-import-info.php') || ($cur_page == 'product_quantity.php')  ) {echo 'active';} ?>">
						<a href="#">
						...
						<ul class="treeview-menu">
							<li><a href="product.php"><i class="fa fa-circle-o"></i> Quản lý sản phẩm</a></li>
							<li><a href="product_quantity.php"><i class="fa fa-circle-o"></i> Quản lý số lượng sản phẩm</a></li>
                            <li><a href="product-import-info.php"><i class="fa fa-circle-o"></i> Thông tin nhập kho</a></li>
                        </ul>
                    </li>
