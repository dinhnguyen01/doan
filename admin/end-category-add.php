...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn một danh mục phòng<br>";
    }
    ...
    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục loại sản phẩm không được để trống<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục loại sản phẩm được thêm thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Thêm danh mục loại sản phẩm</h1>
	</div>
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên danh mục loại sản phẩm <span>*</span></label>
							<div class="col-sm-4">
