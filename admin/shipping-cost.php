...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">Lưu ý: Nếu một quốc gia không tồn tại trong danh sách trên, chi phí vận chuyển của các quốc gia còn lại sau đây sẽ được áp dụng cho quốc gia đó.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Chi phí vận chuyển (Các quốc gia còn lại)</h1>
    </div>
</section>
