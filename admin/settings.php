...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang tìm kiếm được cập nhật thành công.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang danh mục sản phẩm được cập nhật thành công.';
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_10" data-toggle="tab">Tập lệnh Head & Body</a></li>
