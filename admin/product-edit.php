...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn danh mục phòng<br>";
    }
    ...
    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn danh mục loại sản phẩm<br>";
    }
    ...
    if($_POST['p_old_price'] <= 0) {
		$valid = 0;
		$error_message .= "Giá gốc phải lớn hơn 0<br>";
	}
	
	if($_POST['p_current_price'] < 0) {
		$valid = 0;
		$error_message .= "Giá hiện tại không được nhỏ hơn 0<br>";
	}
	
	// if($_POST['p_qty'] < 0) {
	// 	$valid = 0;
	// 	$error_message .= "Số lượng không được nhỏ hơn 0<br>";
	// }
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục phòng <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục sản phẩm <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Danh mục loại sản phẩm <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá gốc<br><span style="font-size:10px;font-weight:normal;">(VNĐ)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá giảm <span>*</span><br><span style="font-size:10px;font-weight:normal;">(VNĐ)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh hiện có</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh thay thế </label>
							<div class="col-sm-4" style="padding-top:4px;">
