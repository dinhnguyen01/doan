                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo number_format($shipping_cost, 0, '.', ',') ?><?php echo LANG_VALUE_1; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo number_format($final_total, 0, '.', ',') ?><?php echo LANG_VALUE_1; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Bạn phải điền tất cả thông tin thanh toán và giao hàng từ bảng điều khiển để thanh toán đơn hàng. Vui lòng điền thông tin <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">tại đây</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Chuyển khoản"><?php echo LANG_VALUE_38; ?></option>
	                                    </select>
	                                </div>
